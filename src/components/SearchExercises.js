...
import { Box,Stack,TextField,Typography,Button, colors } from '@mui/material';
    ...
    <Stack alignItems='center' justifyContent='center' mt='37px' p='20px'>
      ...
      <Box position='relative' mb='72px'>
        ...
        <Button className='search-btn'
         sx={{bgcolor:'blue',color:'#fff',textTransform:'none',width:{lg:'175px',xs:"80px"},fontSize:{lg:'20px',xs:'14px'},height:'56px',position:'absolute',right:'0'}}
